...
[简体中文](/docs/README_zh-CN.md)&nbsp;&nbsp;|&nbsp;&nbsp;繁體中文&nbsp;&nbsp;|&nbsp;&nbsp;[English](/docs/README_en-US.md)&nbsp;&nbsp;|&nbsp;&nbsp;[Українська](/docs/README_uk_UA.md)&nbsp;&nbsp;|&nbsp;&nbsp;[Português (Brasil)](/docs/README_pt-BR.md)

</div>

## 當前支持的版本

Android 17 的 HyperOS 4.0
...
目前 HyperCeiler 是基於 Android 17 的 Xiaomi HyperOS 4.0 的手機端設備進行適配，覆蓋不是很完整，需要不斷測試和改進。

提交反饋前請注意是否已有相同反饋，避免給開發者造成困擾。花相同精力看相同反饋是一件很浪費時間的事情。

HyperCeiler 已停止維護 Android 11-16 的所有 MIUI 和 HyperOS 1.0/2.0/3.0 ROM。
...
>
> Android 14-16 的 HyperOS 1.0/2.0/3.0 已歸檔，從 3.0.0 版本開始將移除對 Android 16 及以下版本的支持。

## 項目規劃

Xiaomi HyperOS 3 or 4 將是本項目的一個終點，就目前來說，小米官方有選擇性的根據 Xposed 的功能調整了自己的（反人類）功能，模組的功能也隨著系統的更新在逐漸減少。

也是一步步看著澎湃從沒 Root 不能用到變得差不多能用的樣子（小米平板除外）

未來本模組會深度適配 HyperOS 3.0 及以上版本（但不保證功能上都能用），HyperOS 2 會在後續維護中歸檔（因為變化差距大）
...
| LPA                | com.miui.euicc                     |
| 小米SIM卡激活服務         | com.xiaomi.simactivate.service     |
| 跨屏協同服務             | com.xiaomi.mirror                  |
...
我們使用了 Hosted Weblate 進行項目翻譯同步，您可以在[這裡](https://hosted.weblate.org/engage/hyperceiler/)為 HyperCeiler 項目貢獻翻譯。
...
> 注：當新語言翻譯進度大於或等於 85% 時，將會進入合併流程，如果已添加的語言，翻譯進度小於或等於源文本的 30%，將會暫時被移除，直到重新滿足翻譯進度大於或等於 85%。

## 感謝

> HyperCeiler 使用了以下開源項目的部分或全部內容，感謝這些項目的開發者提供的大力支持（排名順序不分先後）。
...
- [「MIUI 通知修復」 by tehcneko](https://github.com/Xposed-Modules-Repo/io.github.tehcneko.miuinotificationfix)
- [「ModemPro」 by Weverse](https://github.com/Weverse/ModemPro)
